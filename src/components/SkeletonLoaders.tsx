    ...
    <div className="px-5 md:px-8 lg:px-12 py-6 md:py-10 max-w-350 mx-auto w-full animate-pulse">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-start">
        ...
        <div className="md:col-span-7 lg:col-span-8 space-y-6">
          ...
          <div className={`rounded-3xl p-6 md:p-8 border space-y-4 ${
            isDark ? 'bg-[#1b201d] border-stone-800' : 'bg-[#f0eee9] border-stone-300/60'
          }`}>
            <div className="flex justify-between">
              <Bar w="w-24" h="h-3.5" />
              <div className="h-9 w-9 rounded-xl bg-stone-300 dark:bg-stone-700" />
            </div>
            <Bar w="w-3/4" h="h-8" className="rounded-lg" />
            <Bar w="w-full" h="h-4" />
            <Bar w="w-1/3" h="h-3" />
            <div className="flex gap-3 pt-2">
              <Bar w="w-36" h="h-11" className="rounded-2xl" />
              <Bar w="w-36" h="h-11" className="rounded-2xl" />
            </div>
          </div>
        ...
        <div className="md:col-span-5 lg:col-span-4 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[1, 2].map((i) => (
              <div key={i} className={`p-5 rounded-2xl border flex flex-col items-center gap-3 ${
                isDark ? 'bg-[#1b201d] border-stone-800' : 'bg-white border-stone-200/70'
              }`}>
